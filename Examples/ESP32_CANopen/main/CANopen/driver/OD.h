...
********************************************************************************
    ...
    File info:
        ...
        Project File: TMTES_Sensor_Board.xdd
        File Version: 1

        Created:      2023-11-01 19:12:54
        Created By:   KMITL & AES
        Modified:     2023-11-03 15:12:16
        Modified By:  

    Device Info:
        Vendor Name:  
        Vendor ID:    
        Product Name: TMT_Enose_3_Sensors_Board
        Product ID:   
...
#define OD_CNT_ARR_1F81 15
#define OD_CNT_ARR_1F82 15
#define OD_CNT_ARR_6401 15
#define OD_CNT_ARR_6402 15
#define OD_CNT_ARR_6501 1
#define OD_CNT_ARR_6503 1
#define OD_CNT_ARR_6504 4
...
typedef struct {
    ...
    uint8_t x6401_gasSensorValue16Bit_sub0;
    uint8_t x6402_gasSensorOffset16Bit_sub0;
    struct {
        uint8_t highestSub_indexSupported;
        uint32_t subObject1;
    } x6403_gasSensorGain16Bit;
    uint8_t x6501_machineID_sub0;
    uint8_t x6501_machineID[OD_CNT_ARR_6501];
    uint16_t x6502_machineName[17];
    uint8_t x6503_machineStatus_sub0;
    uint32_t x6503_machineStatus[OD_CNT_ARR_6503];
    uint8_t x6504_digitalOutputControl_sub0;
    uint8_t x6504_digitalOutputControl[OD_CNT_ARR_6504];
} OD_RAM_t;
...
#define OD_ENTRY_H1F80 &OD->list[23]
#define OD_ENTRY_H1F81 &OD->list[24]
#define OD_ENTRY_H1F82 &OD->list[25]
#define OD_ENTRY_H1F89 &OD->list[26]
#define OD_ENTRY_H6401 &OD->list[27]
#define OD_ENTRY_H6402 &OD->list[28]
#define OD_ENTRY_H6403 &OD->list[29]
#define OD_ENTRY_H6501 &OD->list[30]
#define OD_ENTRY_H6502 &OD->list[31]
#define OD_ENTRY_H6503 &OD->list[32]
#define OD_ENTRY_H6504 &OD->list[33]
...
#define OD_ENTRY_H1F80_NMTStartup &OD->list[23]
#define OD_ENTRY_H1F81_slaveAssignment &OD->list[24]
#define OD_ENTRY_H1F82_requestNMT &OD->list[25]
#define OD_ENTRY_H1F89_bootTime &OD->list[26]
#define OD_ENTRY_H6401_gasSensorValue16Bit &OD->list[27]
#define OD_ENTRY_H6402_gasSensorOffset16Bit &OD->list[28]
#define OD_ENTRY_H6403_gasSensorGain16Bit &OD->list[29]
#define OD_ENTRY_H6501_machineID &OD->list[30]
#define OD_ENTRY_H6502_machineName &OD->list[31]
#define OD_ENTRY_H6503_machineStatus &OD->list[32]
#define OD_ENTRY_H6504_digitalOutputControl &OD->list[33]
